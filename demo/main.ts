...
const MANDELBROT_DIALS: Dial[] = [
  ...
  { key: 'aimEase', label: 'aimEase', min: 0.1, max: 5, step: 0.1, value: MANDELBROT_DEFAULTS.aimEase },
  {
    ...
    max: 2,
    step: 0.05,
    value: MANDELBROT_DEFAULTS.aimSmooth,
    note: '0 puts a corner at every re-aim',
  },
  {
    key: 'traceSpeed',
    label: 'traceSpeed',
    ...
    max: 0.4,
    step: 0.005,
    value: MANDELBROT_DEFAULTS.traceSpeed,
    note: 'how fast it walks the edge',
  },
  {
    key: 'traceDistance',
    label: 'traceDistance',
    ...
    max: 8,
    step: 0.1,
    value: MANDELBROT_DEFAULTS.traceDistance,
    note: 'cells off the boundary it follows',
  },
  {
    key: 'exploreEvery',
    label: 'exploreEvery',
    ...
    max: 40,
    step: 1,
    value: MANDELBROT_DEFAULTS.exploreEvery,
    note: 'seconds between pauses to look around',
  },
  { key: 'exploreFor', label: 'exploreFor', min: 1, max: 20, step: 0.5, value: MANDELBROT_DEFAULTS.exploreFor },
  {
    key: 'retreatChance',
    label: 'retreatChance',
    min: 0,
    max: 1,
    step: 0.05,
    value: MANDELBROT_DEFAULTS.retreatChance,
    note: 'how many pauses back out instead',
  },
  {
    key: 'retreatDoublings',
    label: 'retreatDoublings',
    min: 0.5,
    max: 8,
    step: 0.25,
    value: MANDELBROT_DEFAULTS.retreatDoublings,
  },
  {
    key: 'turnEase',
    label: 'turnEase',
    ...
    max: 2,
    step: 0.05,
    value: MANDELBROT_DEFAULTS.turnEase,
    note: '0 reverses in a single frame',
  },
  ...
  if (effect === 'mandelbrot') {
    handle = createMandelbrotBackground(canvas, {
      ...
      mandelbrot: {
        ...
        aimSmooth: values.aimSmooth,
        turnEase: values.turnEase,
        traceSpeed: values.traceSpeed,
        traceDistance: values.traceDistance,
        exploreEvery: values.exploreEvery,
        exploreFor: values.exploreFor,
        retreatChance: values.retreatChance,
        retreatDoublings: values.retreatDoublings,
